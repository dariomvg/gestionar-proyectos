...
export default function VistaProyecto({params}: PropsParamsId ): JSX.Element {
  const { project, setProject, updateProject, isDisabled, setIsDisabled } = useFindProject(params.id);
